...
function AddPost() {
  return (
    <Container>
      <Post>
        <AddInput>
          <Avatar src="https://lh3.googleusercontent.com/ogw/ADea4I7uMbKP1_XStzAzV6FXYFhZu2rLvUO_froY-W53Uw=s32-c-mo" />
          <input placeholder="Whats on your mind, lan chhaim?" type="text" />
        </AddInput>
        <Options>
          <Icon>
